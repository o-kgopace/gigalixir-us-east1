...
PROJECT_URL = os.environ.get('URL', 'https://aws-us-east1.gigalixirapp.com') # 
INTERVAL_SECONDS = int(os.environ.get("TIME", 120))                   # 
UUID = os.environ.get('UUID', '4c8eb935-bab4-4c83-91b3-340f41e1350f')
...
NAME = os.environ.get('NAME', 'gigalixir-US-East1')
